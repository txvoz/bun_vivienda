...
if (true === true) {
    ...
    for ($var = 0; $var < 25/5; $var++) {
        ?>
        {
        "id_request": <?php echo mt_rand(0, 100) ?>,
        "identification": <?php echo mt_rand(0, 100) ?>08546698,
        "first_name": "TTT<?php echo mt_rand(0, 100) ?>",
        "last_name": "TTT<?php echo mt_rand(0, 100) ?>",
        "middle_name": "TTT<?php echo mt_rand(0, 100) ?>",
        "middle_last_name": "TTT<?php echo mt_rand(0, 100) ?>",
